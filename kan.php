...
$ua[] = "user-agent: Mozilla/5.0 (Linux; Android 11; V2043) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36";
$login = "https://github.com/monosans/proxy-list/raw/refs/heads/main/proxies/socks5.txt";
$ch = curl_init();
...
$vvv = "Mozilla/5.0 (Linux;) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.".$no.".130 Mobile DuckDuckGo/".$no." Safari/537.36";
$headers = [
...
$url = "https://faucetearner.org/?r=334547422228";
